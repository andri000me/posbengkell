...
var dashgrin = function(){
	...
	$(document).on('click', '#navtop_light_select', function (e) {
		$navbar.removeClass('navbar-dark').addClass('navbar-light').find('img.brand-img').attr('src','<?= base_url(); ?>assets_new/img/depina_logo.png');
		return false;
	});
	$(document).on('click', '#navtop_dark_select', function (e) {
		$navbar.removeClass('navbar-light').addClass('navbar-dark').find('img.brand-img').attr('src','<?= base_url(); ?>assets_new/img/depina_logo.png');
		return false;
	});

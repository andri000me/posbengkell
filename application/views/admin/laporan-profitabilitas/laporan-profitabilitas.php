	          ...
	          <div class="row">
	              <div class="col-sm">
	                  <div class="table-wrap">
						  ...
						  <hr />
						  <?php 
								  $hrefExcel	=	site_url('profitabilitas-excel');
								  $hrefPDF 		=	site_url('profitabilitas-pdf');
						 		if(!is_null($column) && !is_null($start) && !is_null($end)){
									$hrefExcel 	=	site_url('profitabilitas-excel').'?column='.$column.'&start='.$start.'&end='.$end;
									$hrefPDF 	=	site_url('profitabilitas-pdf').'?column='.$column.'&start='.$start.'&end='.$end;
								} 
						  ?>

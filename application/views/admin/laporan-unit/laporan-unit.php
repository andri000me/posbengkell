	                      ...
	                      <table id="konten" class="table table-hover w-100 display pb-30">
				              ...
				              <!-- <tfoot>
				                <tr>
				                  ...
				                  <th colspan="3"  scope="col" id='total-amount' style="text-align:right"></th>
				                </tr>
				              </tfoot> -->
	                      </table>
						  <hr />
						  <?php 
								  $hrefExcel	=	site_url('unit-excel');
								  $hrefPDF 		=	site_url('unit-pdf');
						 		if(!is_null($column) && !is_null($start) && !is_null($end)){
									$hrefExcel 	=	site_url('unit-excel').'?column='.$column.'&start='.$start.'&end='.$end;
									$hrefPDF 	=	site_url('unit-pdf').'?column='.$column.'&start='.$start.'&end='.$end;
								} 
						  ?>

<div class="hk-settings-panel">
    <div class="nicescroll-bar position-relative">
        <div class="settings-panel-wrap">
            <div class="settings-panel-head">
                <img class="brand-img" src="<?= base_url(); ?>assets_new/img/logo.png" alt="brand" width="100px"/>                
            ...
            <div class="button-list hk-nav-select mb-10">
                ...
                <button type="button" id="nav_dark_select" class="btn btn-outline-success btn-sm btn-wth-icon icon-wthot-bg"><span class="icon-label"><i class="fa fa-moon-o"></i> </span><span class="btn-text">Dark Mode</span></button>
            </div>
            <hr>
    ...
    <!-- <img class="d-none" src="<?= base_url(); ?>assets_new/img/logo-light.png" alt="brand" /> -->
    <!-- <img class="d-none" src="<?= base_url(); ?>assets_new/img/logo-dark.png" alt="brand" /> -->
</div>